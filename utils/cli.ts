...
cli
  ...
  .option("--access-key <accessKey>", "AWS Access Key (or use env var S3_ACCESS_KEY)", process.env.S3_ACCESS_KEY)
  .option("--secret-key <secretKey>", "AWS Secret Key (or use env var S3_SECRET_KEY)", process.env.S3_SECRET_KEY);
